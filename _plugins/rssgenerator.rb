      ...
      rss = RSS::Maker.make("2.0") do |maker|
        ...
        site.posts.docs.reverse[0..post_limit].each do |post|
          maker.items.new_item do |item|
            ...
            # Convert excerpt or content to string
            excerpt_or_content = post.data['excerpt'] || post.content
            excerpt_or_content = excerpt_or_content.to_s

            # Parse the excerpt or content
            item.description = parser.convert(excerpt_or_content)
